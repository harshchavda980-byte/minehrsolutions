...
!function(i) {
    ...
    : (e(window, o),
    module.exports = i(o, window, window.document))) : i(jQuery, window, document)
}(function(n, t, i) {
    "use strict";
    ...
    return n.extend(e.ext.buttons, {
        ...
        columnVisibility: {
            ...
            _columnText: function(n, t) {
                var i, o;
                return "string" == typeof t.text ? t.text : (o = n.column(t.columns).title(),
