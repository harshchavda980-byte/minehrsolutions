...
!function(o) {
    ...
    }) : "object" == typeof exports ? (l = require("jquery"),
    n = function(t, e) {
    ...
    : (n(window, l),
    module.exports = o(l, window, window.document))) : o(jQuery, window, document)
}(function(S, C, u) {
    "use strict";
    ...
    function c(t, e) {
        ...
        e.footer && n.footer && (i = n.footerStructure.map(function(t) {
            return o(t.map(function(t) {
                return t ? t.title : ""
            }))
        }).join(l) + l);
        for (var s = 0, m = n.body.length; s < m; s++)
            f.push(o(n.body[s]));
        return {
            str: t + f.join(l) + l + i,
            rows: f.length
    ...
    function A(t, e, o) {
        ...
        return o && (o.attr && S(l).attr(o.attr),
        o.children && S.each(o.children, function(t, e) {
            l.appendChild(e)
        }),
        null !== o.text) && void 0 !== o.text && l.appendChild(t.createTextNode(o.text)),
        l
    }
        ...
        action: function(t, e, o, l, n) {
            ...
            if (u.queryCommandSupported("copy")) {
                ...
                try {
                    ...
                    if (i.remove(),
                    f)
                        return l.copySuccess && e.buttons.info(e.i18n("buttons.copyTitle", "Copy to clipboard"), e.i18n("buttons.copySuccess", {
    ...
    t.ext.buttons.excelHtml5 = {
        ...
        action: function(t, e, o, f, l) {
            ...
            f.autoFilter && (S("mergeCells", c).before(A(c, "autoFilter", {
                attr: {
    ...
    t.ext.buttons.pdfHtml5 = {
        ...
        action: function(t, e, o, l, n) {
            ...
            for (var p = 0, i = r.body.length; p < i; p++)
                d.push(r.body[p].map(function(t) {
                    return {
            ...
            s().createPdf(f));
            "open" !== l.download || m() ? e.download(a.filename) : e.open(),
            n()
        },
        async: 100,
        title: "*",
