...
!function(n) {
    ...
    var T, X, t, e, V = function(e, P) {
        ...
        this.each(function() {
            ...
            if ("table" != this.nodeName.toLowerCase())
                ...
                e = tt(H.extend(!0, {}, r), e),
                $(c.oFeatures, e, ["bPaginate", "bLengthChange", "bFilter", "bSort", "bSortMulti", "bInfo", "bProcessing", "bAutoWidth", "bSortClasses", "bServerSide", "bDeferRender"]),
                $(c, e, ["ajax", "fnFormatNumber", "sServerMethod", "aaSorting", "aaSortingFixed", "aLengthMenu", "sPaginationType", "iStateDuration", "bSortCellsTop", "iTabIndex", "sDom", "fnStateLoadCallback", "fnStateSaveCallback", "renderer", "searchDelay", "rowId", "caption", "layout", "orderDescReverse", "typeDetect", ["iCookieDuration", "iStateDuration"], ["oSearch", "oPreviousSearch"], ["aoSearchCols", "aoPreSearchCols"], ["iDisplayLength", "_iDisplayLength"]]),
                $(c.oScroll, e, [["sScrollX", "sX"], ["sScrollXInner", "sXInner"], ["sScrollY", "sY"], ["bScrollCollapse", "bCollapse"]]),
                ...
                c.oFeatures);
                if (e.bStateSave && (F.bStateSave = !0),
                void 0 === e.aaSorting)
    ...
    H.extend(V.ext.classes, {
        ...
        search: {
            container: "dt-search float-right",
            input: "dt-input"
        },
        table: "dataTable",
        tbody: {
        ...
        paging: {
            ...
            container: "dt-paging float-right mt-2",
            disabled: "disabled",
            nav: ""
        }
    }),
    ...
    function ne(e) {
        !function(t) {
            if (t.oFeatures.bAutoWidth) {
                var e, n, r = t.nTable, a = t.aoColumns, o = t.oScroll, i = o.sY, l = o.sX, o = o.sXInner, s = ie(t, "bVisible"), u = r.getAttribute("width"), c = r.parentNode, d = r.style.width, f = Ue(t);
                ...
                d.remove(),
                u && (r.style.width = I(u)),
                !u && !l || t._reszEvt || (m = V.util.throttle(function() {
                    var e = Ue(t);
                ...
                t.resizeObserver.observe(o[0])) : H(W).on("resize.DT-" + t.sInstance, m),
                t._reszEvt = !0)
            }
        }(e);
    ...
    function ye(e, t, n, r) {
        function a(e, t) {
            ...
            v(e)(r, t.getAttribute(n)))
        }
        function o(e) {
            void 0 !== n && n !== d || (l = f[d],
            s = e.innerHTML.trim(),
            l && l._bAttrSrc ? (v(l.mData._)(r, s),
            a(l.mData.sort, e),
            a(l.mData.type, e),
            a(l.mData.filter, e)) : h ? (l._setter || (l._setter = v(l.mData)),
            l._setter(r, s)) : r[d] = s),
            d++
        }
    ...
    function Ce(e) {
        var t = e.oLanguage
          , n = t.sZeroRecords
          , r = J(e);
        return e.iDraw < 1 && "ssp" === r || e.iDraw <= 1 && "ajax" === r ? n = t.sLoadingRecords : t.sEmptyTable && 0 === e.fnRecordsTotal() && (n = t.sEmptyTable),
        H("<tr/>").append(H("<td />", {
            colSpan: oe(e),
    ...
    function Ie(t) {
        ...
        t.sDom)
            for (var o, i, l, s, u, c, d = t, e = t.sDom, f = a, h = e.match(/(".*?")|('.*?')|./g), p = 0; p < h.length; p++)
                ...
                p++),
                f.append(l),
                f = l) : ">" == i ? f = f.parent() : "t" == i ? o = Be(d) : V.ext.feature.forEach(function(e) {
    ...
    function Ae(e, t, n) {
        for (var r, a, o, i, l, s, u = e.aoColumns, c = H(t).children("tr"), d = t && "thead" === t.nodeName.toLowerCase(), f = [], h = 0, p = c.length; h < p; h++)
            f.push([]);
        for (h = 0,
        p = c.length; h < p; h++)
            for (a = (r = c[h]).firstChild; a; ) {
                if ("TD" == a.nodeName.toUpperCase() || "TH" == a.nodeName.toUpperCase()) {
                    var g, v, m, b, y, D = [];
                    for (b = (b = +a.getAttribute("colspan")) && 0 != b && 1 != b ? b : 1,
                    ...
                    (m = a.style.width.match(/width:\s*(\d+[pxem%]+)/)) && (v = m[1]),
                    g.sWidthOrig = g.sWidth || v,
                    d ? (null === g.sTitle || g.autoTitle || (a.innerHTML = g.sTitle),
                    !g.sTitle && s && (g.sTitle = w(a.innerHTML),
                    g.autoTitle = !0)) : g.footer && (a.innerHTML = g.footer),
                    g.ariaTitle || (g.ariaTitle = H(a).attr("aria-label") || g.sTitle),
                    g.className) && H(a).addClass(g.className),
                    0 === H("span.dt-column-title", a).length && H("<span>").addClass("dt-column-title").append(a.childNodes).appendTo(a),
                    d) && 0 === H("span.dt-column-order", a).length && H("<span>").addClass("dt-column-order").appendTo(a),
                    i = 0; i < b; i++) {
                        for (o = 0; o < y; o++)
                            f[h + o][l + i] = {
                                cell: a,
    ...
    function Ne(n, e, r) {
        function t(e) {
            ...
            if ((null === e || "number" == typeof t && 204 == t) && Fe(n, e = {}, []),
    ...
    function Me(i) {
        ...
        n = function() {
            ...
            d(i),
            "ssp" == c && !u || ("ajax" == c ? Ne(i, {}, function(e) {
                var t = Fe(i, e);
            ...
            t.aiDisplay.length) {
                ...
                if (p)
                    for (var b = H(p).children("th, td").map(function(e) {
                        ...
                        y.style.width.replace("px", "") !== b[v].width && (y.style.width = b[v].width + "px",
                        e.sX) && (y.style.minWidth = b[v].width + "px")
                    }
            }
    ...
    function Ze(e, t, n) {
        ...
        a = c.length; r < a; r++) {
            ...
            for (var D = V.ext.type.order[b.sType + "-pre"], x = v.aoData, S = 0; S < x.length; S++)
                ...
                p._aSortData[m] && !y || (g = y ? h[S] : q(v, S, m, "sort"),
    ...
    function Ke(n) {
        var t, e;
        n._bLoadingState || (Ge(n, e = [], n.aaSorting),
        t = n.aoColumns,
        e = {
            time: +new Date,
    ...
    function et(r, e, t) {
        ...
        if (e && e.time) {
            ...
            if (0 < s && e.time < +new Date - 1e3 * s)
                ...
                r.iInitDisplayStart = e.start) : Xe(r, e.start / r._iDisplayLength)),
                void 0 !== e.order && (r.aaSorting = [],
                H.each(e.order, function(e, t) {
                    var n = [t[0], t[1]];
                    "string" == typeof t[0] ? (t = i.indexOf(t[0]),
                    n[0] = 0 <= t ? t : 0) : n[0] >= o.length && (n[0] = 0),
                    r.aaSorting.push(n)
                })),
    ...
    function(e, t) {
        ...
        var n = this.context;
        return void 0 === e ? n.length && this.length && n[0].aoData[this[0]] ? n[0].aoData[this[0]]._details : void 0 : (!0 === e ? this.child.show() : !1 === e ? wt(this) : n.length && this.length && ht(n[0], n[0].aoData[this[0]], e, t),
        this)
    }),
    ...
    t("order()", function(t, e) {
        ...
        return void 0 === t ? 0 !== n.length ? n[0].aaSorting : void 0 : ("number" == typeof t ? t = [[t, e]] : 1 < r.length && (t = r),
    ...
    t(["columns().search.fixed()", "column().search.fixed()"], function(n, r) {
        var e = this.iterator(!0, "column", function(e, t) {
            ...
            return n ? void 0 === r ? e[n] : (null === r ? delete e[n] : e[n] = r,
            this) : Object.keys(e)
        });
    ...
    t("destroy()", function(c) {
        ...
        this.iterator("table", function(e) {
            ...
            H(a).find("span.dt-column-title").each(function() {
                var e = H(this).html();
            ...
            H("th, td", a).removeClass(u.none + " " + u.canAsc + " " + u.canDesc + " " + u.isAsc + " " + u.isDesc).css("width", "").removeAttr("data-dt-column").removeAttr("aria-sort"),
            r.children().detach(),
            r.append(s),
    ...
    function At(e, t, n) {
        ...
        i = W.moment && !i ? W.moment : i) {
            ...
            t ? (It || alert("DataTables warning: Formatted date without Moment.js or Luxon - https://datatables.net/tn/17"),
            It = !0) : r = new Date(e);
        return r
    }
    function Nt(s) {
        return function(r, a, o, i) {
            ...
            function(e, t) {
                ...
                "type" === t ? l : "" === e ? "sort" !== t ? "" : At("0000-01-01 00:00:00", null, o) : !(null === a || r !== a || "sort" === t || "type" === t || e instanceof Date) || null === (n = At(e, r, o)) ? e : "sort" === t ? n : (e = null === a ? Lt(n, "toDate", "toJSDate", "")[s]() : Lt(n, "format", "toFormat", "toISOString", a),
                "display" === t ? u(e) : e)
            }
        }
    }
    ...
    if (void 0 !== W.Intl)
        try {
            for (var jt = (new Intl.NumberFormat).formatToParts(100000.1), r = 0; r < jt.length; r++)
                "group" === jt[r].type ? Ft = jt[r].value : "decimal" === jt[r].type && (Ot = jt[r].value)
        } catch (e) {}
            ...
            _: function(g, v, m) {
                ...
                "disable" === v.attr("data-dt-order") || "disable" === v.parent().attr("data-dt-order") || !0 === e && 0 !== n || !1 === e && n !== t.length - 1 || H(g.nTable).on("order.dt.DT column-visibility.dt.DT", function(e, t) {
                    if (g === t) {
                        var n = t.sortDetails;
                        if (n) {
                            for (var r = m.order, a = t.api.columns(v), o = g.aoColumns[a.flatten()[0]], i = a.orderable().includes(!0), l = "", s = a.indexes(), u = a.orderable(!0).flatten(), c = b(n, "col"), d = g.iTabIndex, f = (v.removeClass(r.isAsc + " " + r.isDesc).toggleClass(r.none, !i).toggleClass(r.canAsc, i && u.includes("asc")).toggleClass(r.canDesc, i && u.includes("desc")),
                            !0), h = 0; h < s.length; h++)
                                c.includes(s[h]) || (f = !1);
                            f && (u = a.order(),
                            v.addClass(u.includes("asc") ? r.isAsc : "" + u.includes("desc") ? r.isDesc : ""));
                            var p = -1;
                            ...
                            s[0] == p ? (a = n[0],
                            u = o.asSorting,
                            v.attr("aria-sort", "asc" === a.dir ? "ascending" : "descending"),
                            l = u[a.index + 1] ? "Reverse" : "Remove") : v.removeAttr("aria-sort"),
                            i && ((r = v.find(".dt-column-order")).attr("role", "button").attr("aria-label", i ? o.ariaTitle + t.api.i18n("oAria.orderable" + l) : o.ariaTitle),
                            -1 !== d) && r.attr("tabindex", d)
                        }
                    }
                })
            }
    ...
    V.feature.register("div", function(e, t) {
        var n = H("<div>")[0];
        return t && (kt(n, "className", t.className),
        kt(n, "id", t.id),
    ...
    V.feature.register("search", function(n, r) {
        ...
        (s = H("<div>").addClass(e.container).append(l.replace(/_INPUT_/, o))).find("label").attr("for", "dt-search-" + Mt),
    ...
    return V.feature.register("pageLength", function(r, e) {
        ...
        function(t) {
            ...
            h[0][p] = new Option("number" == typeof i[p] ? r.fnFormatNumber(i[p]) : i[p],o[p]);
        return c.find("label").attr("for", "dt-length-" + Vt),
