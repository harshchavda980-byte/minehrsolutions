...
!function(a) {
    ...
    var j = "ontouchstart"in window || navigator.MaxTouchPoints > 0 || navigator.msMaxTouchPoints > 0
        ...
        var b = function(b) {
          ...
          , ba = function(a, c) {
            ...
            if (0 === a.offset) {
                ...
                aa(a.node) ? (d = a.node.childNodes[a.offset - 1],
                e = G(d)) : (d = a.node,
                e = c ? 0 : a.offset - 1);
            return {
                node: d,
          ...
          , ca = function(a, c) {
            ...
            if (G(a.node) === a.offset) {
                ...
                aa(a.node) ? (d = a.node.childNodes[a.offset],
                e = 0) : (d = a.node,
          ...
          , ea = function(a) {
            if (e(a.node) || !aa(a.node) || H(a.node))
                return !0;
      ...
      , p = function(b, c) {
        ...
        this.initialize = function() {
            return this.layoutInfo = e.createLayout(b, c),
            this._initialize(),
            b.hide(),
            this
        }
        ...
        this.removeModule = function(a) {
            var c = this.modules[a];
            c.shouldInitialize() && (c.events && o.detachEvents(b, c.events),
            c.destroy && c.destroy()),
    ...
    a.fn.extend({
        summernote: function() {
            ...
            if (f.length) {
                ...
                if (c)
                    return g.invoke.apply(g, m.from(arguments));
    ...
    var q = function(b, c, d, e) {
        this.render = function(f) {
            var g = a(b);
            if (d && d.contents && g.html(d.contents),
            d && d.className && g.addClass(d.className),
            d && d.data && a.each(d.data, function(a, b) {
                g.attr("data-" + a, b)
            }),
      ...
      , r = {
        create: function(b, c) {
            return function() {
                ...
                return e && e.children && (d = e.children),
                new q(b,d,e,c)
            }
        }
    }
      ...
      , E = r.create('<div class="note-color-palette"/>', function(a, b) {
        ...
        a.html(c.join("")),
        b.tooltip && a.find(".note-color-btn").tooltip({
            container: "body",
            trigger: "hover",
            placement: "bottom"
        })
      ...
      , F = r.create('<div class="modal" aria-hidden="false" tabindex="-1"/>', function(a, b) {
        ...
        a.html(['<div class="modal-dialog">', '  <div class="modal-content">', b.title ? '    <div class="modal-header">      <h4 class="modal-title">' + b.title + '</h4>      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>    </div>' : "", '    <div class="modal-body">' + b.body + "</div>", b.footer ? '    <div class="modal-footer">' + b.footer + "</div>" : "", "  </div>", "</div>"].join(""))
    })
      ...
      , H = r.create('<label class="custom-control custom-checkbox"></label>', function(a, b) {
        ...
        a.html([' <input type="checkbox" class="custom-control-input"' + (b.id ? ' id="' + b.id + '"' : ""), (b.checked ? " checked" : "") + "/>", ' <span class="custom-control-indicator"></span>', ' <span class="custom-control-description">' + (b.text ? b.text : "") + "</span>", "</label>"].join(""))
    })
      , I = function(a, b) {
    ...
    var K = function() {
        ...
        var b = function(a, b) {
            ...
            if (0 !== c && o.isText(g[c - 1])) {
                ...
                for (var k = j.text.replace(/[\r\n]/g, "").length; k > i.nodeValue.length && i.nextSibling; )
                    ...
                    i = i.nextSibling;
                i.nodeValue;
                b && i.nextSibling && o.isText(i.nextSibling) && k === i.nodeValue.length && (k -= i.nodeValue.length,
                i = i.nextSibling),
                e = i,
                c = k
            }
          ...
          , d = function(b, e, f, g) {
            ...
            this.normalize = function() {
                var a = function(a, b) {
                    if (o.isVisiblePoint(a) && !o.isEdgePoint(a) || o.isVisiblePoint(a) && o.isRightEdgePoint(a) && !b || o.isVisiblePoint(a) && o.isLeftEdgePoint(a) && b || o.isVisiblePoint(a) && o.isBlock(a.node) && o.isEmpty(a.node))
                        return a;
            ...
            this.nodes = function(a, b) {
                ...
                return o.walkPoint(e, f, function(b) {
                    if (!o.isEditable(b.node)) {
                        var e;
                        d ? (o.isLeftEdgePoint(b) && h.push(b.node),
                        o.isRightEdgePoint(b) && m.contains(h, b.node) && (e = b.node)) : e = c ? o.ancestor(b.node, a) : b.node,
                        e && a(e) && g.push(e)
                    }
                }, !0),
                m.unique(g)
            ...
            this.splitText = function() {
                var a = b === f
                  , c = this.getPoints();
                return o.isText(f) && !o.isEdgePoint(this.getEndPoint()) && f.splitText(g),
                o.isText(b) && !o.isEdgePoint(this.getStartPoint()) && (c.sc = b.splitText(e),
                c.so = 0,
                a && (c.ec = c.sc,
                c.eo = g - e)),
            ...
            this.wrapBodyInlineWithPara = function() {
                if (o.isBodyContainer(b) && o.isEmpty(b))
                    return b.innerHTML = o.emptyPara,
                    new d(b.firstChild,0,b.firstChild,0);
                var a = this.normalize();
                if (o.isParaInline(b) || o.isPara(b))
                    return a;
                var c;
                if (o.isInline(a.sc)) {
                    var e = o.listAncestor(a.sc, l.not(o.isInline));
                    c = m.last(e),
                    o.isInline(c) || (c = e[e.length - 2] || a.sc.childNodes[a.so])
                } else
                    c = a.sc.childNodes[a.so > 0 ? a.so - 1 : 0];
                var f = o.listPrev(c, o.isParaInline).reverse();
                if (f = f.concat(o.listNext(c.nextSibling, o.isParaInline)),
                f.length) {
        ...
        return {
            ...
            createFromSelection: function() {
                ...
                if (k.isW3CRangeSupport) {
                    ...
                    var m = b(l, !0)
                      , n = b(j, !1);
                    o.isText(m.node) && o.isLeftEdgePoint(m) && o.isTextNode(n.node) && o.isRightEdgePoint(n) && n.node.nextSibling === m.node && (m = n),
                    a = m.cont,
                    c = m.offset,
                    e = n.cont,
                    f = n.offset
            ...
            createFromNode: function(a) {
                var b = a
                  ...
                  , d = a
                  , e = o.nodeLength(d);
                return o.isVoid(b) && (c = o.listPrev(b).length - 1,
                b = b.parentNode),
                o.isBR(d) ? (e = o.listPrev(d).length - 1,
                d = d.parentNode) : o.isVoid(d) && (e = o.listPrev(d).length,
                d = d.parentNode),
                this.create(b, c, d, e)
            },
      ...
      , O = function() {
        ...
        this.styleNodes = function(b, c) {
            ...
            if (b.isCollapsed())
                return [b.insertNode(o.create(d))];
        ...
        this.current = function(b) {
            ...
            return d.anchor = b.isOnAnchor() && o.ancestor(b.sc, o.isAnchor),
      ...
      , P = function() {
        ...
        this.wrapList = function(a, b) {
            ...
            f && (o.appendChildNodes(g, m.from(f.childNodes)),
            o.remove(f)),
            a
        }
        ,
        this.releaseList = function(b, c) {
            ...
            return a.each(b, function(b, e) {
                ...
                !c && o.isList(h.parentNode) || (e = e.map(function(a) {
      ...
      , R = function(a, b, c, d) {
        ...
        function m(a) {
            ...
            case R.where.Column:
                if (a.isColSpan)
                    return R.resultAction.SumSpanCount;
    ...
    var S, T = function() {
        ...
        this.addRow = function(b, c) {
            for (var d = o.ancestor(b.commonAncestor(), o.isCell), e = a(d).closest("tr"), f = this.recoverAttributes(e), g = a("<tr" + f + "></tr>"), h = new R(d,R.where.Row,R.requestAction.Add,a(e).closest("table")[0]), i = h.getActionList(), j = 0; j < i.length; j++) {
                ...
                case R.resultAction.SumSpanCount:
                    ...
                    n++,
                    k.baseCell.setAttribute("rowSpan", n)
                }
            }
            if ("top" === c)
                e.before(g);
            ...
            for (var c = o.ancestor(b.commonAncestor(), o.isCell), d = a(c).closest("tr"), e = d.children("td, th").index(a(c)), f = d[0].rowIndex, g = new R(c,R.where.Row,R.requestAction.Delete,a(d).closest("table")[0]), h = g.getActionList(), i = 0; i < h.length; i++)
                if (h[i]) {
                    ...
                    case R.resultAction.AddCell:
                        ...
                        n.cells[e].innerHTML = "") : 2 === m && (n.insertBefore(p, n.cells[e]),
                    ...
                    case R.resultAction.SubtractSpanCount:
                        ...
                        k.rowIndex !== f && j.cellIndex === e && (j.innerHTML = "")) : 2 === m && (j.removeAttribute("rowSpan"),
                        k.rowIndex !== f && j.cellIndex === e && (j.innerHTML = "")));
                        continue;
                ...
                if (g[h])
                    ...
                    case R.resultAction.SubtractSpanCount:
                        ...
                        if (j) {
                            ...
                            i.cellIndex === e && (i.innerHTML = "")) : 2 === k && (i.removeAttribute("colSpan"),
        ...
        this.createTable = function(b, c, d) {
            ...
            return d && d.tableClassName && k.addClass(d.tableClassName),
            k[0]
        }
        ,
        ...
        this.handleKeyMap = function(a) {
            ...
            var f = c[d.join("+")];
            f ? (a.preventDefault(),
            b.invoke(f)) : K.isEdit(a.keyCode) && this.afterCommand()
        }
        ,
        ...
        , v = ["bold", "italic", "underline", "strikethrough", "superscript", "subscript", "justifyLeft", "justifyCenter", "justifyRight", "justifyFull", "formatBlock", "removeFormat", "backColor", "fontName"], w = 0, x = v.length; w < x; w++)
            this[v[w]] = function(a) {
                return function(b) {
                    t(),
        ...
        this.tab = function() {
            ...
            a.isCollapsed() && a.isOnCell() ? p.tab(a) : (t(),
            q.insertTab(a, g.tabSize),
            u())
        }
        ,
        ...
        this.getSelectedText = function() {
            var a = this.createRange();
            return a.isOnAnchor() && (a = L.createFromNode(o.ancestor(a.sc, o.isAnchor))),
            a.toString()
        }
        ,
        ...
        this.fontSize = function(b) {
            ...
            if (c && c.isCollapsed()) {
                ...
                e && !o.nodeLength(e) && (e.innerHTML = o.ZERO_WIDTH_NBSP_CHAR,
                L.createFromNodeAfter(e.firstChild).select(),
                f.data("bogus", e))
            } else
                t(),
                a(n.styleNodes(c)).css({
                    "font-size": b + "px"
                }),
                u()
        }
        ...
        this.getLinkInfo = function() {
            ...
            return c.length && (d.isNewWindow = "_blank" === c.attr("target")),
            d
        }
        ,
        ...
        this.events = {
            "summernote.keydown": function(a, d) {
                c.needKeydownHook() && (d.ctrlKey || d.metaKey) && d.keyCode === K.code.V && (b.invoke("editor.saveRange"),
                c.$paste.focus(),
                setTimeout(function() {
                    c.pasteByHook()
                }, 0))
        ...
        this.pasteByEvent = function(a) {
            ...
            if (c && c.items && c.items.length) {
                ...
                "file" === d.kind && -1 !== d.type.indexOf("image/") && b.invoke("editor.insertImagesOrCallback", [d.getAsFile()]),
        ...
        this.attachDragAndDropEvent = function() {
            ...
            h.onDragenter = function(a) {
                ...
                c || f.length || !e || (d.addClass("dragover"),
                i.width(d.width()),
                i.height(d.height()),
            ...
            i.on("drop", function(c) {
                ...
                d && d.files && d.files.length ? (c.preventDefault(),
                e.focus(),
                b.invoke("editor.insertImagesOrCallback", d.files)) : a.each(d.types, function(c, e) {
                    var f = d.getData(e);
    ...
    var X = function(a) {
        ...
        this.activate = function() {
            if (d.val(o.html(c, e.prettifyHtml)),
            d.height(c.height()),
      ...
      , Z = function(b) {
        ...
        this.toggle = function() {
            ...
            this.isFullscreen() ? (f.data("orgHeight", f.css("height")),
            h.on("resize", this.onResize).trigger("resize"),
            i.css("overflow", "hidden")) : (h.off("resize", this.onResize),
            this.resizeTo({
                h: f.data("orgHeight")
            }),
      ...
      , $ = function(b) {
        ...
        this.initialize = function() {
            this.$handle = a(['<div class="note-handle">', '<div class="note-control-selection">', '<div class="note-control-selection-bg"></div>', '<div class="note-control-holder note-control-nw"></div>', '<div class="note-control-holder note-control-ne"></div>', '<div class="note-control-holder note-control-sw"></div>', '<div class="', f.disableResizeImage ? "note-control-holder" : "note-control-sizing", ' note-control-se"></div>', f.disableResizeImage ? "" : '<div class="note-control-selection-info"></div>', "</div>", "</div>"].join("")).prependTo(e),
        ...
        this.update = function(c) {
            ...
            if (b.invoke("imagePopover.update", c),
            d) {
                var f = a(c)
                  , g = f.position()
                  , h = {
      ...
      , ca = function(b) {
        var c = this
          ...
          , i = this.representShortcut = function(a) {
            var b = h[a];
            return f.shortcuts && b ? (k.isMac && (b = b.replace("CMD", "⌘").replace("SHIFT", "⇧")),
        ...
        this.isFontInstalled = function(a) {
            return c.fontInstalledMap.hasOwnProperty(a) || (c.fontInstalledMap[a] = k.isFontInstalled(a) || m.contains(f.fontNamesIgnoreCheck, a)),
        ...
        this.tableMoveHandler = function(b) {
            ...
            3 < k.c && k.c < f.insertTableMaxSize.col && i.css({
                width: k.c + 1 + "em"
            }),
      ...
      , ea = function(b) {
        ...
        this.show = function() {
            ...
            this.showLinkDialog(a).then(function(a) {
                b.invoke("editor.restoreRange"),
      ...
      , ga = function(b) {
        ...
        this.show = function() {
            b.invoke("editor.saveRange"),
            this.showImageDialog().then(function(a) {
                d.hideDialog(c.$dialog),
                b.invoke("editor.restoreRange"),
                "string" == typeof a ? b.invoke("editor.insertImage", a) : b.invoke("editor.insertImagesOrCallback", a)
            }).fail(function() {
                b.invoke("editor.restoreRange")
            })
        }
      ...
      , ja = function(b) {
        ...
        this.createVideoNode = function(b) {
            ...
            if (e && 11 === e[1].length) {
                ...
                c = a("<iframe>").attr("frameborder", 0).attr("src", "https://instagram.com/p/" + g[1] + "/embed/").attr("width", "612").attr("height", "710").attr("scrolling", "no").attr("allowtransparency", "true");
            ...
            return c.addClass("note-video-clip"),
            c[0]
        }
        ,
        this.show = function() {
            ...
            b.invoke("editor.saveRange"),
            this.showVideoDialog(a).then(function(a) {
                d.hideDialog(c.$dialog),
                b.invoke("editor.restoreRange");
      ...
      , ma = function(b) {
        ...
        this.nodeFromItem = function(a) {
            ...
            return "string" == typeof d && (d = o.createText(d)),
            d
        }
        ,
        this.createItemTemplates = function(b, c) {
            ...
            return c.map(function(c, e) {
                ...
                return f.append(d.template ? d.template(c) : c + ""),
                f.data({
                    index: b,
                    item: c
                }),
        ...
        ,
        this.handleKeydown = function(a) {
            this.$popover.is(":visible") && (a.keyCode === K.code.ENTER ? (a.preventDefault(),
            this.replace()) : a.keyCode === K.code.UP ? (a.preventDefault(),
            this.moveUp()) : a.keyCode === K.code.DOWN && (a.preventDefault(),
            this.moveDown()))
        }
        ,
        ...
        this.createGroup = function(b, d) {
            ...
            return this.searchKeyword(b, d, function(a) {
                a = a || [],
                a.length && (e.html(c.createItemTemplates(b, a)),
                c.show())
            }),
            e
        }
